...
public record DeliveryOrderNotificationData(
    ...
    /**
     * Variables match the approved WhatsappTemplate#ORDER_RECEIVED_DELIVERY placeholders:
     *   {{1}} = bill number (e.g. BB-20260706-0001)
     *   {{2}} = customer name
     *   {{3}} = customer phone
     *   {{4}} = delivery address — single line
    ...
    public Map<String, String> templateVariables() {
        ...
        vars.put("4", orEmpty(deliveryAddress));
